...
from beavr.components.environment.leap_hand_isaac import LeapHandEnv
from beavr.components.operators.leap_sim import LeapHandSimOperator
...
class LeapSimIsaacConfig:
    ...
    environment: list = field(default_factory=lambda: [LeapHandEnvCfg(host='10.31.152.148', camport='10005', jointanglepublishport=10012, jointanglesubscribeport=10013, timestamppublisherport=10008, endeff_publish_port=10009, endeffpossubscribeport=10010, actualanglepublishport=10011, stream_oculus=True)])
