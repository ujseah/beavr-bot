...
class LeapHandEnv(Hand_Env):
        def __init__(self,
            ...
            logger.info("Trying to make simulation")
            ...
            logger.info("Loading asset '%s' from '%s'" % (asset_file, asset_root)) 
            # Load the assets 
        ...
        def create_env(self):
            ...
            if self.env_suite !='None':
                ...
                logger.info("Env suite is not None")
            ...
            logger.info("DOF (Joint) Names:")
            for i in (dof_names):
                logger.info(f"Joint {i}")
        ...
        def get_endeff_position(self):
            ...
            logger.info(f"End Effector Position: {position}")
            return position
