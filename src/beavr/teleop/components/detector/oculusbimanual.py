from beavr.constants import VR_FREQ,  ARM_LOW_RESOLUTION, ARM_HIGH_RESOLUTION
from beavr.teleop.components import Component
from beavr.teleop.utils.timer import FrequencyTimer
from beavr.teleop.utils.network import create_pull_socket, ZMQKeypointPublisher
...
class OculusVRTwoHandDetector(Component):
    ...
    def stream(self):
        ...
        logger.info('Stopping the oculus keypoint extraction process.')