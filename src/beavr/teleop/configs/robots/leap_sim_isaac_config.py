...
class LeapHandSimOperatorCfg:
    ...
    def build(self):
        return LeapHandSimOperator(
            ...
            jointanglepublishport=self.jointanglepublishport,
...
class LeapHandEnvCfg:
    ...
    def build(self):
        return LeapHandEnv(
            ...
            jointanglepublishport=self.jointanglepublishport,
            jointanglesubscribeport=self.jointanglesubscribeport,
            timestamppublisherport=self.timestamppublisherport,
            endeff_publish_port=self.endeff_publish_port,
            endeffpossubscribeport=self.endeffpossubscribeport,
            actualanglepublishport=self.actualanglepublishport,
            stream_oculus=self.stream_oculus,
        )
