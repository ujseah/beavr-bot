...
def get_policy_class(name: str) -> PreTrainedPolicy:
    ...
    if name == "tdmpc":
        from beavr.lerobot.common.policies.tdmpc.modeling_tdmpc import TDMPCPolicy
        ...
        from beavr.lerobot.common.policies.act.modeling_act import ACTPolicy
        ...
        from beavr.lerobot.common.policies.pi0fast.modeling_pi0fast import PI0FASTPolicy
