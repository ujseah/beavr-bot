...
class RX1Right:
    """
    RX1Right is a Python class that:
    ...
    def stream(self):
        ...
        while True:
            try:
                ...
                print(f"[RX1Right] Error in stream loop: {e}")
    ...
    def send_robot_pose(self):
        ...
        if robot_ee_pose is None:
            print("[RX1Right] No end-effector pose available to send.")
            return
        ...
        try:
            ...
            if self.debug:
                ...
                print(f"Position: {robot_ee_pose[:3]}")
                print(f"Orientation: {robot_ee_pose[3:]}")

            self._ee_pose_op_pub.pub_keypoints(pose_homo, 'endeff_homo')
            print("[RX1Right] Sent current EE pose as 'endeff_homo'.")
            
        except Exception as e:
            print(f"[RX1Right] Error in send_robot_pose: {e}")
    ...
    def cleanup(self):
        print("[RX1Right] Cleaning up ZMQ connections...")
