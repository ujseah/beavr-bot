...
class RX1GazeboEnv:
    def __init__(self, 
        ...
        print("RX1 Gazebo Environment initialized and connected to ROS")
    ...
    def stream(self):
        ...
        print("Start controlling the RX1 in Gazebo using the Oculus Headset.\n")
    ...
    def cleanup(self):
        ...
        try:
            ...
            print("Successfully cleaned up RX1GazeboEnv resources")
