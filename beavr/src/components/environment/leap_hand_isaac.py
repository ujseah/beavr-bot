...
#import torch
from beavr.src.components import Component
from beavr.src.utils.timer import FrequencyTimer
from beavr.src.utils.network import ZMQCameraPublisher, ZMQCompressedImageTransmitter,ZMQKeypointPublisher,ZMQKeypointSubscriber
from beavr.src.components.environment.hand_env import Hand_Env
...
class LeapHandEnv(Hand_Env):
        def __init__(self,
            ...
            asset_file_dict={
                        ...
                        "leap_hand": "leap_hand/leap_hand_right.urdf",
            }
        ...
        def create_env(self):
            ...
            object_pos = {
                    "cube_flipping": gymapi.Vec3(1, 1.3, -0.1),
