...
echo "\`\`\`bash"
echo "# Basic usage with dev environment (default)"
echo "python -m beavr.teleop.main --robot_name=leap_xarm_right"
echo ""
echo "# Use production environment"
echo "python -m beavr.teleop.main --robot_name=leap_xarm_right --config_file=config/prod.yaml"
echo ""
echo "# Use staging environment"
echo "python -m beavr.teleop.main --robot_name=leap_xarm_right --config_file=config/staging.yaml"
echo ""
